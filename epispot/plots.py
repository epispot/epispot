...
def plot_comp_nums(Model, timesteps, starting_state=None, seed=100):
    ...
    -  seed: Defaults to 100, for generating new random colors
...
def compare(ranges, title="", subtitle="", markers=None, seed=200):
    ...
    -  ranges: A list of items to plot. Follow the idiom below:
                    ...
                    label (in str() format), ... ]
    -  title: Defaults to "", (str) the title of the plot
    -  subtitle: Defaults to "", (str) the subtitle of the plot
    -  markers: Defaults to [], a list of sequenced markers in the format:
    ...
    -  seed: Defaults to 200, for generating new random colors
    - Returns matplotlib plot (log scale)
    """
